<template>
  ...
  <div class="add-form">
    ...
    <form @submit.prevent="fetchCreate">
      <div>
        ...
        <input v-model="newChatLieu.tenChatLieu" type="text" required />
      </div>
      <div>
        <label>Mô tả:</label>
        <input v-model="newChatLieu.moTa" type="text" />
      </div>
      <div>
  ...
  <div class="edit-form" v-if="showEditForm">
    ...
    <form @submit.prevent="fetchUpdate">
      <div>
        <label>Tên chất liệu:</label>
        <input v-model="selectedChatLieu.tenChatLieu" type="text" required />
      </div>
      <div>
        <label>Mô tả:</label>
        <input v-model="selectedChatLieu.moTa" type="text" />
      </div>
      <div>
        <label for="">Trạng thái</label>
    ...
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-body">
        <div class="detail-row">
          ...
          <div class="detail-value">{{ selectedChatLieu.id }}</div>
        </div>
        <div class="detail-row">
          <div class="detail-label">Tên chất liệu:</div>
          <div class="detail-value">{{ selectedChatLieu.tenChatLieu }}</div>
        </div>
        <div class="detail-row">
...
const paginatedChatLieus = computed(() => {
  return ChatLieus.value.slice(startIndex.value, endIndex.value);
});
...
const fetchAll = async () => {
  try {
    ...
    totalItems.value = ChatLieus.value.length; // Update total items for pagination
  } catch (error) {
