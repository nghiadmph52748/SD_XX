<template>
  ...
  <div class="management-header">
    <div class="title-section">
      ...
      <h3 class="sub-title">Quản lý xuất xứ</h3>
    </div>
        ...
        <form @submit.prevent="fetchCreate">
          <div class="detail-row">
            ...
            <div class="detail-value">
              <input v-model="newXuatXu.tenXuatXu" type="text" required class="detail-input" />
            </div>
          </div>
          <div class="detail-row">
        ...
        <div>
          ...
          <div class="detail-row">
            ...
            <div class="detail-value">
              <div class="radio-group">
                <label class="radio-label">
                  <input type="radio" name="detailTrạng thái" :value="false" v-model="selectedXuatXu.deleted" />
                  <span>Hoạt động</span>
                </label>
                <label class="radio-label">
                  <input type="radio" name="detailTrạng thái" :value="true" v-model="selectedXuatXu.deleted" />
                  <span>Không hoạt động</span>
                </label>
              </div>
            </div>
