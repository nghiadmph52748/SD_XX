<template>
  ...
  <div class="management-header">
    <div class="title-section">
      ...
      <h3 class="sub-title">Quản lý nhà sản xuất</h3>
    </div>
        ...
        <form @submit.prevent="fetchCreate">
          <div class="detail-row">
            ...
            <div class="detail-value">
              <input v-model="newNSX.tenNhaSanXuat" type="text" required class="detail-input" />
            </div>
          </div>
          <div class="detail-row">
  ...
  <div v-if="totalPages > 1" class="pagination-wrapper">
    <div class="pagination-info">
      Hiển thị {{ startIndex + 1 }} - {{ endIndex }} của {{ totalItems }} nhà sản xuất
    </div>
        ...
        <div>
          ...
          <div class="detail-row">
            ...
            <div class="detail-value">
              <div class="radio-group">
                <label class="radio-label">
                  <input type="radio" name="detailTrạng thái" :value="false" v-model="selectedNSX.deleted" />
                  <span>Hoạt động</span>
                </label>
                <label class="radio-label">
                  <input type="radio" name="detailTrạng thái" :value="true" v-model="selectedNSX.deleted" />
                  <span>Không hoạt động</span>
                </label>
              </div>
            </div>
